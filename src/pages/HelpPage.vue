...
const shortcuts = [
  ...
  { action: 'Shift+клик по карточке', result: 'Выбрать вторую персону для расчёта родства' },
  {
    action: 'Поле «Поиск…» в шапке',
    result: 'Подсветить совпавшие карточки и приглушить остальные',
  },
  { action: 'Esc', result: 'Отмена создания связи, закрытие меню и диалогов, очистка поиска, сброс расчёта родства' },
...
<template>
  <div class="min-h-screen bg-gray-100 font-sans">
    ...
    <main class="mx-auto max-w-3xl px-6 py-8">
      ...
      <section class="mb-6 rounded-lg bg-white p-5 shadow-sm">
        ...
        <ul class="list-disc space-y-1 pl-5 text-sm leading-relaxed text-gray-700">
          <li>
            ...
            <span class="font-medium">верхний фиолетовый пин</span> — брак.
          </li>
          <li>
      ...
      <section class="mb-6 rounded-lg bg-white p-5 shadow-sm">
        <h2 class="mb-3 text-lg font-bold text-gray-900">Расчёт родства</h2>
        <p class="mb-2 text-sm leading-relaxed text-gray-700">
          Приложение подсказывает, кем друг другу приходятся две персоны:
        </p>
        <ul class="list-disc space-y-1 pl-5 text-sm leading-relaxed text-gray-700">
          <li>
            Кликните по карточке первой персоны (якорь A), затем Shift+кликните по карточке второй —
            персона B получит изумрудную обводку.
          </li>
          <li>
            Приложение находит кратчайший путь между персонами в графе связей и показывает термин
            родства с коленом, например «двоюродный прадедушка (5-е колено)».
          </li>
          <li>
            Результат отображается в панели слева сверху холста: «A → B · термин». Точный термин
            подсвечен зелёным, приближённый (путь проходит через браки) — янтарным. Если пути между
            персонами нет, панель не показывается.
          </li>
          <li>Закрыть расчёт можно клавишей Esc или кнопкой «×» в панели.</li>
        </ul>
      </section>
